...
const DoctorHeader = () => {
  return (
    <div className="relative bg-gradient-to-br from-white via-[#1a365d]/5 to-[#6ed54e]/5 lg:py-20 py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-6" data-aos="fade-right">
            <div className="flex items-center gap-3">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#1a365d]/5 to-[#6ed54e]/5 px-4 py-2 rounded-full border border-[#6ed54e]/20">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
              Meet Our <span className="text-[#1a365d]">Super Specialist</span>{" "}
              <br />
              <span className="text-[#de2226]">Doctors</span>
            </h1>
            <p className="text-lg text-gray-600 max-w-xl leading-relaxed">
              A dedicated team of experienced doctors works together to
              understand your needs. Their focus is on keeping you healthy,
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="sm:px-8 px-6 sm:py-3.5 py-2.5 bg-[#1a365d] text-white rounded-lg font-semibold hover:bg-[#1a365d]/90 
                  transition-all duration-300 shadow-lg shadow-[#1a365d]/20 hover:shadow-xl hover:shadow-[#1a365d]/30 sm:text-base text-sm"
              ...
              <Link
                to="/bookappointment"
                className="sm:px-8 px-6 sm:py-3.5 py-2.5 bg-[#de2226] text-white rounded-lg font-semibold hover:bg-[#6ed54e]/90 
