  ...
  return (
    <>
        ...
        >
          ...
          <div
            className="border-4 border-[#1d55b0] rounded-xl overflow-hidden relative"
            data-aos="zoom-in"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-[#1d55b0]/20 via-[#4a90e2]/10 to-[#1d55b0]/20 pointer-events-none z-10"></div>
            <iframe
