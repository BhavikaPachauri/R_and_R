const dummyData = [
  ...
  },
  {
    ...
    doc_image:
      "./img/Imran-Ahmad-Khan.webp",
  },
    {
    doc_name: "Dr. Vitthal Vaikar",
    doc_profile: "MBBS, DNB (General Surgery)",
    doc_details: "General & Laparoscopic Surgeon",
    doc_image:
      "./speciality/img/Vitul-Vaikar.webp",
  },
   {
    ...
    doc_image:
      "./speciality/img/Amit-singh.webp",
  },
  
  {
    ...
    doc_image:
      "./speciality/img/Mukesh-kumar.webp",
  },
   
  {
    doc_name: "Dr. Deepak Jhagharia",
    doc_profile: "MBBS, MS (Ortho)",
    doc_details: "Endoscopic Spine & Joint Surgeon",
    doc_image:
      "./speciality/img/Deepak-jhadia.webp",
  },
    {
    ...
    doc_image:
      "./speciality/img/Sunil-Saini.webp",
  },
  {
 ...
 
  {
    ...
    doc_image:
      "./speciality/img/SameerKhan.webp",
  },
];
