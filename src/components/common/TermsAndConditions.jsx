...
const TermsAndConditions = () => {
  return (
    <div className="bg-gray-100 lg:py-14 py-10">
      <div className="lg:max-w-[1293px] px-3 mx-auto">
        <h1 className="lg:text-5xl text-3xl font-bold text-center mb-6 text-[#1d55b0]">
          Terms and Conditions
        </h1>
        <p className="text-xl font-semibold text-center mb-4 text-[#1d55b0]">
          Welcome to Baba Yogi Neta Nath Multi-Speciality Hospital
        </p>

        <p className="mb-4 ">
          These terms and conditions outline the rules and regulations for the
          use of R&R Multispecialty  Hospital's website, accessible at
          <a
        ...
        <p className="mb-4 ">
          ...
          the confidentiality of your account and password, as well as for
        ...
        <p className="mb-4 ">
          ...
          enjoyment of the website. Prohibited behaviour includes, but is not
          limited to, hacking, spamming, or transmitting harmful software.
        </p>
        ...
        <p className="mb-4 ">
          ...
          website are owned by or licensed to R&R Multispecialty  Hospital. You may not
        ...
        <p className="mb-4 ">
          ...
          only and is not intended as medical advice. Always seek the advice of
        ...
        <p className="mb-4 ">
          In no event shall R&R Multispecialty  Hospital be liable for any damages arising from
        ...
        <p className="mb-4 ">
          ...
          controlled by R&R Multispecialty  Hospital. We have no control over the content and
        ...
        <p className="mb-4 ">
          R&R Multispecialty  Hospital reserves the right to update or change these terms and
        ...
        <p className="mb-4">
          ...
          <a
            href="https://wa.me/91 8432655555"
            target="_blank"
            rel="noopener noreferrer"
            className="text-green-600 hover:underline"
          >
        ...
        <p className="mt-6 font-medium ">
          ...
          choosing R&R Multispecialty  Hospital.
        </p>
      </div>
    </div>
  );
