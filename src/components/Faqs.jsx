...
const Faqs = () => {
  ...
  return (
      ...
      <div className="relative bg-gradient-to-br from-blue-50 via-white to-blue-50 lg:py-20 py-12 sm:py-16 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-2000"></div>
        ...
        <div className="max-w-7xl mx-auto relative">
          <motion.div 
            ...
            data-aos="fade-up"
          >
            <span className="inline-block px-3 sm:px-4 py-1 sm:py-1.5 mb-3 sm:mb-4 text-xs sm:text-sm font-semibold text-blue-600 bg-blue-100 rounded-full">
              Healthcare Support
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 bg-gradient-to-r from-blue-600 via-blue-700 to-purple-600 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="md:col-span-2 space-y-3 sm:space-y-4" data-aos="fade-right">
              {faqData.map((faq, index) => (
                ...
                >
                  ...
                  >
                    <span className="font-semibold text-gray-800 text-base sm:text-lg lg:text-xl group-hover:text-blue-600 transition-colors duration-300 pr-4">
                      {faq.question}
                    </span>
                    <motion.div
                    ...
                    >
                      {activeIndex === index ? (
                        <FaMinus className="text-blue-600 w-3 h-3 sm:w-4 sm:h-4" />
                      ) : (
                  ...
                  <AnimatePresence>
                    {activeIndex === index && (
                      ...
                      >
                        <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 bg-gradient-to-r from-blue-50/50 to-purple-50/50">
            ...
            <div className="md:col-span-1 space-y-4 sm:space-y-6 lg:flex flex-col hidden" data-aos="fade-left">
              <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-purple-600 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-white shadow-xl transition-transform duration-300 hover:scale-105">
              ...
              <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-lg border border-blue-100 transition-transform duration-300 hover:scale-105">
                <div className="flex items-center gap-3 mb-4 sm:mb-6">
                  <div className="w-12 sm:w-14 h-12 sm:h-14 bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl sm:rounded-2xl flex items-center justify-center">
                    <svg
                      className="w-6 sm:w-7 h-6 sm:h-7 text-white"
                      fill="none"
                      stroke="currentColor"
                ...
                <a href="tel:9050201111" className="inline-flex items-center text-blue-600 font-semibold hover:text-blue-700 transition-colors duration-300 group text-sm sm:text-base">
